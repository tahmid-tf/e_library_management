                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col d-none d-lg-block mt-xxl-n4">
                            <img
                                ...
                                src="{{ asset('assets/img/illustrations/statistics.svg') }}"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <div class="card bg-primary border-0">
                        <div class="card-body">
                            ...
                            <div
                                class="progress bg-white-25 rounded-pill"
                                style="height: 0.5rem"
                            >
                                <div
                                    class="progress-bar bg-white w-75 rounded-pill"
                                    role="progressbar"
                                    aria-valuenow="75"
                                    aria-valuemin="0"
                                    aria-valuemax="100"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="list-group list-group-flush">
                                        ...
                                        >
                                            <div class="me-3">
                                                <i
                                                    class="fas fa-circle fa-sm me-1 text-purple"
                                                ></i>
                                                Social
                                            </div>
                                        ...
                                        >
                                            <div class="me-3">
                                                <i
                                                    class="fas fa-circle fa-sm me-1 text-green"
                                                ></i>
                                                Referral
                                            </div>
